    ...
    <div class="row mb-4">
        ...
        <div class="col-md-3">
            <div class="card text-white bg-info">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <i class="bi bi-ticket-fill" style="font-size: 2rem; margin-right: 10px;"></i>
                        <div>
                            <h5 class="card-title">Mã giảm giá</h5>
                            <h3 class="card-text">{{ $stats['coupons'] }}</h3>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-3">
            <div class="card text-white bg-secondary">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <i class="bi bi-percent" style="font-size: 2rem; margin-right: 10px;"></i>
                        <div>
                            <h5 class="card-title">Giảm giá sản phẩm</h5>
                            <h3 class="card-text">{{ $stats['product_discounts'] }}</h3>
                        </div>
                    </div>
                </div>
            </div>
